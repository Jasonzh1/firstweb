			...
			<section className="mb-12 md:mb-18">
				...
				<FadeIn>
					<p className="text-muted-foreground leading-relaxed">
						My objective is to build innovative, reliable systems that can
						create real-world impact. My current interests include low-level
						design, specifically improving memory abstractions to better
						optimize performance in data centre workloads.
					</p>
				</FadeIn>
			</section>
